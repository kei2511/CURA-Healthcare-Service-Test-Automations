...
WebUI.waitForElementVisible(findTestObject('Page_CURA Healthcare Service/txt_username'), 5)
...
if (var_expected == 'valid') {
    WebUI.verifyElementVisible(findTestObject('Page_CURA Healthcare Service/lbl_MakeAppointment'), FailureHandling.STOP_ON_FAILURE)
} else {
